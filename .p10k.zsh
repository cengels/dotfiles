# Generated by Powerlevel10k configuration wizard on 2020-03-21 at 09:15 STD.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%F{black}%K{none}\uE0B4 \uE0B6'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%F{black}%K{none}\uE0B4 \uE0B6'
...
#   typeset -g POWERLEVEL9K_PROMPT_CHAR_BACKGROUND=
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%2F'  # yellow foreground
